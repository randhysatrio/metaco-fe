    ...
    <div className="w-full flex items-center">
      ...
      <div className="w-3/4 md:w-4/5 flex items-center">
        <select
          ...
          className="w-4/5 h-10 bg-select_bg text-white font-semibold rounded-xl focus:outline-none focus:border-none focus:ring focus:ring-sky-500 transition cursor-pointer px-3 hover:shadow-[0_0_15px_-6px_rgba(25,190,255,1)]"
        >
